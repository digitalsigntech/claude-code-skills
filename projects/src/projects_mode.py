...
the company/projects/<slug>/ (e.g. "PHD R&D with Claude" → projects/phd-rd/). Everything
...
PROJECTS_DIR = os.path.join(C.APP_ROOT, "projects")
...
OR_VISION_MODEL = os.environ.get("APP_PROJECTS_VISION_MODEL",
