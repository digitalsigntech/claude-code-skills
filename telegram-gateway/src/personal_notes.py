...
from the the company knowledge base, and are deliverable ONLY to:
...
NEVER to the the company groups (Public / Wise / Private) or to any other user's DM.

Storage: the company/personal/notes/<YYYYMMDD-HHMMSS>_<original-name>  (files)
         the company/personal/notes.db                                  (metadata)
...
PERSONAL_DIR = os.path.join(C.APP_ROOT, "personal")
