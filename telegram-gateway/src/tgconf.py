...
def _system_prompt():
    ...
    private. the second install's copy of this file had to be rewritten by hand at install time
...
PHOTO_REFLEX = (os.environ.get("TG_PHOTO_REFLEX", "1") == "1"
                and P.has("image_search"))   # needs a CLIP server; the second install has none
