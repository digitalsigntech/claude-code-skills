...
CLAUDE_MODEL = os.environ.get("TG_MODEL", os.environ.get("APP_TG_MODEL", "claude-fable-5"))
CLAUDE_TIMEOUT = int(os.environ.get("TG_TIMEOUT", os.environ.get("APP_TG_TIMEOUT", "900")))
...
PHOTO_REFLEX = os.environ.get("TG_PHOTO_REFLEX", os.environ.get("APP_PHOTO_REFLEX", "1")) == "1"
...
DOC_REFLEX = os.environ.get("TG_DOC_REFLEX", os.environ.get("APP_DOC_REFLEX", "1")) == "1"
...
FILE_REFLEX = os.environ.get("TG_FILE_REFLEX", os.environ.get("APP_FILE_REFLEX", "1")) == "1"
...
KB_REFLEX = os.environ.get("TG_KB_REFLEX", os.environ.get("APP_KB_REFLEX", "0")) == "1"
...
PRIVACY_MODE = os.environ.get("TG_PRIVACY_MODE", os.environ.get("APP_PRIVACY_MODE", "targeted"))  # off | targeted | strict
