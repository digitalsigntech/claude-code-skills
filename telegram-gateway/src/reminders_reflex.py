...
# install (the second install) needs no second env var: point REMINDERS_DB at that
...
def _mint(path):
    ...
    2026-08-13: a second install (the second install, on its own VPS) has the same reflex and a
