...
**Multiple roots.** The engine is root-agnostic: set `APP_KB_ROOT` (index root) and
`APP_KB_DIRS` (comma-separated subdirs to index; `.` = the whole tree) to point the same
